...
?>
	<section class="collage first">
		<div class="collage_img"><img src="pic/pic_2.jpg" alt=""></div>
	...
	<section class="collage second">
		...
		<div class="collage_img"><img id="animate_index_2" src="pic/pic_3.png" alt=""></div>
	</section>
	...
	<section class="collage fourth">
		...
		<div class="collage_img"><img id="animate_index_2" src="pic/pic_5.jpg" alt=""></div>
	</section>
